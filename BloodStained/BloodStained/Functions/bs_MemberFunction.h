#ifndef _BS_MEMBERFUNCTION_H_
#define _BS_MEMBERFUNCTION_H_
...
namespace bs
{
	...
	public:
		...
		bool operator==(const MemberFunction& other)
		{
			return this->m_caster == other.m_caster && this->m_pointer == other->m_pointer;
		}
