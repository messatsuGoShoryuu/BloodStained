...
void	TexShader3D::initialize()
{
	...
	bs::String vertexSourceString = bs::g_resourceManager.loadText("Shaders/TestUnlitVertex.txt");
	bs::String fragmentSourceString = bs::g_resourceManager.loadText("Shaders/TestUnlitFragment.txt");
